...
const Album = () => {
  ...
  return (
    <div className="relative flex items-center justify-between bg-secondary h-screen">
        <div className="h-screen w-[15%] sm:w-[10%] flex items-center justify-center">
        ...
        <div className="relative h-screen w-[70%] sm:w-[80%] flex flex-col justify-start items-center">
            <div className="h-[10%] w-full flex justify-between items-center mx-5">
                <CustomLink url='/' text='HOME' />
                <h1 className="text-xl sm:text-2xl" style={{textShadow: "2px 2px yellow"}}>PAGE {page}</h1>
                <CustomLink url='/quiz' text='PLAY' />
            </div>
            <div className="h-[90%] flex flex-wrap w-full items-center justify-between">
                {
